<template>
  <q-page class="hand-log-level-page q-pa-md">
    <div class="page-container">
      <!-- 대회 또는 레벨이 없을 때 -->
      <q-card v-if="!event || !blindLevel" flat bordered class="empty-card">
        ...
        <q-card flat bordered class="section-card q-mb-md">
          <q-card-section>
            <div class="q-mb-md">
              ...
              <div class="text-body2 text-grey-7 q-mt-xs">이 레벨에서 기록한 핸드입니다.</div>
            </div>
              ...
              >
                <q-card-section>
                  <div class="row items-center justify-between q-col-gutter-md">
                    ...
                    <div v-if="hand.reviewRequired || hand.important" class="col-auto">
...
const addHand = (payload) => {
  handLogStore.addHandToBlindLevel(eventId.value, levelId.value, {
    ...payload,
